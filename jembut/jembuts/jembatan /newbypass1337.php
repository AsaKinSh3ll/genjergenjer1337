...
<body>
    <div class="menu-header">
        <ul>
            ...
            <li><i class="fa-brands fa-telegram"></i>&nbsp;@AsaKin1337</li>
            <li class="logo-gecko"><img width="400" height="400" src="https://i.ibb.co.com/ymfzFXDM/image-removebg-preview.png" align="right"></li>
